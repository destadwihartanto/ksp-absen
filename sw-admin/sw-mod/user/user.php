           ...
           while ($row_a= $result->fetch_assoc()) {
              ...
              <tr>
                ...
                <td class="text-right">
                  ...
                  if($level_user==1){
                  echo'
                  <a href="#modalEdit2" class="btn btn-warning btn-xs enable-tooltip disable" title="Edit" data-toggle="modal"';?> onclick="getElementById('txtid').value='<?PHP echo $row_a['user_id'];?>';getElementById('txtnama').value='<?PHP echo $row_a['fullname'];?>';getElementById('txtuser').value='<?PHP echo $row_a['username'];?>';getElementById('txtemail').value='<?PHP echo $row_a['email'];?>';getElementById('txtlevel').value='<?PHP echo $row_a['level'];?>';"><i class="fa fa-pencil-square-o"></i> Ubah</a><?PHP }
                  else{
                  ...
                  if($level_user==1){
                    echo'
                         <button data-id="" class="btn btn-sm btn-danger delete" title="Hapus"><i class="fa fa-trash-o"></i> Hapus</button>';
