...
<section class="content">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          if ($level_user == 1) {
            echo '
                      <a href="#modalLihat" class="btn btn-info btn-xs enable-tooltip" title="Lihat" data-toggle="modal"'; ?> onclick="getElementById('txtid').value='<?PHP echo $row['building_id']; ?>';getElementById('txtname').value='<?PHP echo $row['name']; ?>';getElementById('txtaddress').value='<?PHP echo $row['address']; ?>';"><i class="fa fa-eye"></i> Lihat</a>
            <?php echo '
  ...
  <?php echo '
            ...
            echo '
                      <button type="button" class="btn btn-info btn-xs access-failed enable-tooltip" title="Lihat"><i class="fa fa-pencil-square-o"></i> Lihat</button>
...
<div class="modal fade" id="modalLihat" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Menampilkan Jumlah Data Karyawan Pada Lokasi</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <div class="table-responsive">
                    <table id="swdatatable" class="table table-bordered table-hover">
                      <thead>
                        <tr>
                          <th>NO.</th>
                          <th>Nama</th>
