  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      if (!empty($_GET['id'])) {
        ...
        $query = "SELECT employees.id,employees.employees_name,employees.position_id, employees.building_id,position.position_name,building.name FROM employees,position,building 
        WHERE employees.position_id=position.position_id AND employees.id='$id'";
        $result = $connection->query($query);
        if ($result->num_rows > 0) {
        ...
        <h4>Lokasi : <span> ' . $row['name'] . '</span></h4>
        <hr>
        <div class="row">
          <div class="col-md-4">
