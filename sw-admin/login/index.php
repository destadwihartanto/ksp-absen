    ...
    <p class="login-box-msg">Silahkan masukkan username dan password :</p>
     ...
     <hr>
      ...
      <div class="col-md-12" style="min-height:40px;"><span id="stat"></span></div>
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat" id="login">Login</button>
        </div>
        <!-- /.col -->
      </div>
...
<!-- /.login-box -->'; ?>
  ...
  <footer class="text-muted text-center">
    KSP Gadai <a href="https://leonelstudio.com" rel="dofollow" target="_blank"></a><br />
